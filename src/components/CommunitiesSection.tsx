...
export default function CommunitiesSection() {
  return (
    <section className="bg-primary py-12 sm:py-14 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-10 mb-8">
          {communities.map((name) => (
            <div
              key={name}
              className="bg-white rounded-xl px-5 sm:px-7 py-2.5 sm:py-3.5 shadow-md"
            >
